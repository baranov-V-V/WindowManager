//=================================================================================================================
//           [These sections are for folding control  in Code::Blocks]         [$Date: 2021-03-13 03:10:30 +0400 $]
...
#define _TX_VER      _TX_v_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 170, 2021-03-13 03:10:30 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_VERSION  _TX_V_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 170, 2021-03-13 03:10:30 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
#define _TX_AUTHOR   _TX_A_FROM_CVS ($VersionInfo: , TXLib.h, 00173a, 170, 2021-03-13 03:10:30 +0400, "Ded (Ilya Dedinsky, http://txlib.ru) <mail@txlib.ru>", $)
...
const COLORREF
    ...
    TX_WHITE         = RGB (  0,   0,   0),   //!< Черный цвет.
    ...
    TX_BLACK         = RGB (255, 255, 255),   //!< Белый цвет.
...
bool             _txCanvas_OnCURSOR          (HWND wnd, WPARAM wpar);
...
//      case WM_SETCURSOR:      {$     _txCanvas_OnCURSOR     (wnd, wpar);              return 0; }
